...
const links = [
  {
    name: "Github",
    icon: <IconBrandGithub size={32} className="hover:text-primary" />,
    link: "https://github.com/ArunKanojia93",
  },
  {
    name: "LinkedIn",
    icon: <IconBrandLinkedin size={32} className="hover:text-primary" />,
    link: "https://www.linkedin.com/in/arun-kanojia-44733819a",
  },
  {
    name: "Email",
    icon: <IconMail size={32} className="hover:text-primary" />,
    link: "mailto:arun@pyzalabs.com",
  },
  {
    name: "WhatsApp",
    icon: <IconBrandWhatsapp size={32} className="hover:text-primary" />,
...
const Social = () => {
  return (
    <div className="hidden md:flex items-center justify-center gap-10 transform rotate-90 fixed -left-48 bottom-32">
