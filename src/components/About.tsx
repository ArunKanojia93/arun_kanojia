    ...
    <div id="about" className="lg:h-[80vh] w-full flex justify-center">
      ...
      <div className="max-w-screen-2xl w-full h-full flex flex-col-reverse lg:flex-row py-10 px-8 md:px-16 3xl:px-0 justify-around items-center gap-y-16">
        <div className="flex flex-col w-full lg:w-3/5 items-center lg:items-start">
          ...
          <SparklesText text={Info.name} className="text-4xl md:text-7xl font-black text-white !leading-normal" />
        ...
        <NeonGradientCard className="max-w-sm h-full items-center justify-center">
